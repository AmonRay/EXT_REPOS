...
#define G_SSR_QUALITY					3		// Quality of the SSR. ( 0 = Very low | 1 = Low | 2 = Medium | 3 = High | 4 = Very High | 5 = Ultra )

#define G_SSR_VERTICAL_SCREENFADE		4.0f	// Vertical fade. ( higher values = sharp gradient )

#define G_SSR_INTENSITY					0.5f	// Global reflection intensity ( 1.0f = 100% ~ 0.0f = 0% )
...
#define G_SSR_WEAPON_MAX_INTENSITY		0.012f	// Weapons & arms MAX intensity.
#define G_SSR_WEAPON_MAX_LENGTH			1.5f	// Maximum distance to apply G_SSR_WEAPON_INTENSITY.
