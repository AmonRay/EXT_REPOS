...
uniform float4 shader_param_4; //contrast
uniform float4 shader_param_5; //channel r
uniform float4 shader_param_6; //channel g
uniform float4 shader_param_7; //channel b
