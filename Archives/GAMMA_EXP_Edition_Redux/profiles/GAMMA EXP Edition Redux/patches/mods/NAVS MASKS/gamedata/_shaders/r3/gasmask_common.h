...
#define GM_DIFF_INT 0.40 //Diffuse cracks intensity
#define GM_VIG_INT 0.6 //Vignette intensity
...
#define GM_VIS_NUM 32 //Reflection quality
#define GM_VIS_RADIUS 0.45 //Reflection radius
#define GM_VIS_INTENSITY 0.8 //Reflection intensity
